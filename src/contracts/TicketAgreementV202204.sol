...
contract TicketAgreementV202204 is TicketAgreementBase {
     ...
     */
    function calculateCharge(SharedStructs.FlightDetails calldata flightDetails) internal override view returns(uint256, string memory) {
        ...
        if (ticketData.status == SharedStructs.TicketStatuses.Settled) {
            ...
            if (cancellationTimeDiff > 48 hours) {
                ...
                chargeAmount = (ticketData.amount * 100 * 20) / 100;
                ...
                chargeAmount = (ticketData.amount * 100 * 50) / 100;
                ...
                chargeAmount = (ticketData.amount * 100 * 70) / 100;
                ...
                chargeAmount = (ticketData.amount * 100 * 90) / 100;
                ...
                chargeAmount = (ticketData.amount * 100 * 95) / 100;
            ...
            if (flightDetails.status == SharedStructs.FlightStatuses.Cancelled) {
                ...
                if (departureDelay == 0) {
                    ...
                    chargeAmount = (ticketData.amount * 100 * 98) / 100;
                    ...
                    chargeAmount = (ticketData.amount * 100 * 80) / 100;
